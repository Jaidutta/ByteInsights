...
namespace ByteInsights.Controllers
{
    public class BlogsController : Controller
    {
        ...
        // GET: Blogs/Create
/* Authorize Annotation:: features
 * indicates that the user needs to be logged in
 * Once they are logged in they will be return to the specific Url
 * Authorize(Roles = "Administrator")  indicates: 
 * indicates that the user needs to log in and has to be an Administrator 
 * for using the Action i.e Blog/Create link
 */
